                    ...
                    <div class="card-body card-block">
                        ...
                        <form action="{{route('task.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="txtname_task" placeholder="Text" class="form-control"><small class="form-text text-muted">This is a help text</small></div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="txtdescription_task" placeholder="Text" class="form-control"><small class="form-text text-muted">This is a help text</small></div>
                            </div>
                                ...
                                <div class="col col-md-9">
                                    <div class="form-check-inline form-check">
                                        <label for="inline-radio1" class="form-check-label ">
                                            <input type="radio" id="inline-radio1" name="radiostatus_task" value="0" class="form-check-input">Ongoing
                                        </label>
                                        <label for="inline-radio2" class="form-check-label ml-1 ">
                                            <input type="radio" id="inline-radio2" name="radiostatus_task" value="1" class="form-check-input">Done
                                        </label>
                                    </div>
                                </div>
                            </div>
